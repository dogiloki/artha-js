...
- A la clase BaseComponent se implemento un el atributo reflect en el apuntador especial (_special_props) para indicar si se debe reflejar y obtener los valores en base a un attributo del elemento en el DOM.